<?php
  $con=mysqli_connect("localhost",'sgrutman978', 'terpCode1234',"storyboard");
$url = 'index.php';
...
#editButton:hover, #drawButton:hover{
	color:white;
}
...
<img src="0" id="scream" style="position:fixed;top:-20000px" />
  ...
  <!-- <div class="xOut" style="bottom:-2px;right:-2px">X</div> -->
	...
	<div id='boardWalk' class="beach" style='padding-bottom:6px;position:fixed;color:rgb(125,58,0);width:18.5%;font-size:28px;text-align:center;font-family:Audiowide;top:41px;right:-20%;z-index:10000'>The Boardwalk</div>
...
<div id="notificationsBoard" class="bigBoxes" style="width:60%;height:535px;left:8%;overflow:hidden">
Alerts
...
$("#boardView").scrollLeft(lefter-50);
$("#boardView").scrollTop(topper-50);
    }
